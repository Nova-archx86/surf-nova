...
#define SETPROP(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "| dmenu -fn \"Mononoki Nerd Font:size=15\" -sf \"#222222\" -sb \"#ADFF2F\" -l 10 -p \"$4\" -w $1)\" && xprop -id $1 -f $3 8s -set $3 \"$prop\"", \
...
static Alias aliases[] = {
    ...
    { "wikipedia", "https://www.wikipedia.org" },
		...
		{ "sci",       "https://www.scienceforums.net/"},
		{ "iod", 			 "https://integraloftheday.com/"}
};
